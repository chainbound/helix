...
pub(crate) const PATH_BUILDER_CONSTRAINTS: &str = "/relay/v1/builder/constraints";
pub(crate) const PATH_BUILDER_CONSTRAINTS_STREAM: &str = "/relay/v1/builder/constraints_stream";
pub(crate) const PATH_BUILDER_BLOCKS_WITH_PROOFS: &str = "/relay/v1/builder/blocks_with_proofs";
